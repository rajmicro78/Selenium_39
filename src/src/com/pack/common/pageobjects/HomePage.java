...
public class HomePage {
	...
	@FindBy(xpath="//h2[@class='site-logo']/a")								private WebElement logoImage;
	@FindBy(id="txt-search") 												private WebElement searchBox;
	@FindBy(xpath="//div[contains(@class,'is-search')]/button") 			private WebElement searchButton;
	@FindBy(xpath="//div[contains(@class,'item-mypage')]")					private WebElement mypageicon;
	@FindBy(xpath="//div[contains(@class,'item-info')]")					private WebElement infocentericon;
	@FindBy(xpath="//div[contains(@class,'item-offers')]")					private WebElement offericon;
	@FindBy(xpath="//div[contains(@class,'item-save')]")					private WebElement wishlisticon;
	@FindBy(xpath="//div[contains(@class,'item-cart')]")					private WebElement carticon;
	@FindBy(id="layoutCartValue") 											private WebElement cartValue;
	@FindBy(xpath="//ul[@class='nav-categories']/li")						private List<WebElement> navCategories;
	@FindBy(xpath="//div/section[contains(@class,'usp-bar')][1]")			private WebElement topuspbar;
	@FindBy(id="front-page-banners")										private WebElement banner;
	@FindBy(id="recommendedProductResults")									private WebElement recommendedproduct;
	@FindBy(css=".block.promo-banner")										private WebElement promobanner;
	@FindBy(xpath="//div[contains(@class,'instagram-feed')]")				private WebElement instagramfeed;
	@FindBy(className="block")												private WebElement trustpilot;
	...
	private WebElement bottomuspbar;
	@FindBy(className="section-footer")										private WebElement footer;
	@FindBy(xpath="//a[contains(@href, 'mypage')]")							private WebElement minorderlink;
	@FindBy(id="Email") 													private WebElement emailfield;
	@FindBy(id="btnCheckEmail")												private WebElement chkemail;
	@FindBy(id="Password")													private WebElement passwordfield;
	@FindBy(id="LoginButton")												private WebElement loginBtn;
	@FindBy(xpath="//a[contains(@id,'top_nav_logo')]")						private WebElement topLogo;
	@FindBy(xpath="//a[contains(@href, '#loginPopup-modal')]")				private WebElement NHLoginPopUP; 
